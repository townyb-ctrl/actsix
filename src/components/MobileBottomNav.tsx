  ...
  tasks: {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Weekly Review",
        path: "/tasks/review",
        description: "Clear the inbox and unstick projects.",
      },
    ],
  },
  projects: {
    ...
    >
      <span
        className={cn(
          ...
          active
            ? "bg-brand-teal/10 shadow-[inset_0_0_0_1px_rgba(18,63,60,0.08)]"
    ...
    >
      <span
        className={cn(
          "actsix-mobile-dock-icon",
          emphasis
            ? "bg-brand-teal text-white shadow-[0_8px_18px_rgba(18,63,60,0.2)] group-hover:bg-brand-teal-dark"
            : active
              ? "bg-brand-teal/10 shadow-[inset_0_0_0_1px_rgba(18,63,60,0.08)]"
              : "group-hover:bg-brand-teal/5"
        )}
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 px-3 pb-[calc(env(safe-area-inset-bottom)+0.6rem)] md:hidden">
      <div className="relative mx-auto max-w-md">
        <div
          className={cn(
            "pointer-events-none absolute left-1/2 z-10 h-3 w-3 -translate-x-1/2 rounded-full bg-brand-teal shadow-[0_10px_24px_rgba(18,63,60,0.24)]",
            DOCK_TRANSITION,
            switcherOpen
        ...
        <div
          className={cn(
            "absolute left-1/2 bottom-[5.5rem] z-20 flex h-12 w-[min(90%,21rem)] origin-bottom -translate-x-1/2 items-center justify-between gap-1 overflow-hidden rounded-full border border-white/10 bg-brand-teal px-3 shadow-[0_16px_34px_rgba(18,63,60,0.26)] transition-[transform,opacity] duration-200 ease-out",
            switcherOpen
            ...
            <div className="relative flex h-[54px] items-end justify-center">
              ...
              <button
                ...
                className={cn(
                  ...
                  DOCK_TRANSITION,
                  switcherOpen && "shadow-[0_15px_30px_rgba(18,63,60,0.24)]"
                )}
