    ...
    <div className="w-full">
      <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-end">
        <div className="min-w-0">
          ...
          <h1 className="text-2xl font-extrabold leading-tight md:text-[1.85rem]">
            {title}
          </h1>
          {subtitle && <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-muted-foreground">{subtitle}</p>}
        </div>
