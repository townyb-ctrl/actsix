            ...
            {payments.map((payment) => (
              <li key={payment.id}>
                <button
                  ...
                  className="flex min-h-11 w-full flex-wrap items-center justify-between gap-2 rounded px-1 py-1 text-left text-sm transition hover:bg-muted/40 active:scale-[0.995] motion-reduce:active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal/40"
                >
                  <span>
