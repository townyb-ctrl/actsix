...
const WorkspaceSettingsPage = () => {
  ...
  if (!workspace) {
    return (
      <div>
        ...
        <div className="actsix-page-body">
          <Card className="actsix-panel max-w-2xl p-4 sm:p-5">
  ...
  return (
    <div>
      ...
      <div className="actsix-page-body grid min-w-0 gap-4 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="space-y-4">
          <Card className="actsix-panel p-4 sm:p-5">
            ...
            <div className="mt-4 grid gap-3 rounded-[1rem] border border-border/70 bg-muted/10 p-3.5">
              <div>
          ...
          <Card className="actsix-panel p-4 sm:p-5">
            ...
            <form onSubmit={updateJoinPhrase} className="mt-4 space-y-3">
          ...
          <Card className="actsix-panel p-4 sm:p-5">
            ...
            <Button
              type="button"
              variant="outline"
              className="mt-4 rounded-xl border-destructive/30 text-destructive hover:bg-destructive/10 hover:text-destructive"
        ...
        <Card className="actsix-panel p-4 sm:p-5">
          ...
          {isAdmin && !membersLoading && membersError && (
            <div className="flex min-h-[10rem] flex-col items-start justify-center gap-3 rounded-xl border border-dashed border-border/70 bg-muted/10 p-4 text-left">
              <div>
