-- Avoid overloaded RPC names and make notification read/update access explicit.
...
create or replace function public.actsix_create_notification_for_person(
...
grant execute on function public.actsix_create_notification_for_user(uuid, uuid, text, text, text, text, text) to authenticated;
grant execute on function public.actsix_create_notification_for_person(uuid, uuid, text, text, text, text, text) to authenticated;
