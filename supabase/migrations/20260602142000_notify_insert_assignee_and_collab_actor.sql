-- Notify assignees when a project task is created already assigned, and include actor names.
...
begin
  ...
  perform public.actsix_create_notification_for_person(
    ...
    actor_name || ' added you to ' || coalesce(project_name, 'a project') || ' as ' || coalesce(new.role, 'Collaborator') || '.',
    'project',
    'project',
    new.project_id::text
  );
